function showSubCategory(){
	$("#AllSort dt").mouseover(function(){
			...
			if (newDiv){
				...
				//newDiv.innerHTML=this.nextSibling.innerHTML;这里获取不到对象里的内容,这是dom方法 
                // 改为newDiv.innerHTML=$("#AllSort dt").siblings().eq(0).html();即可
				//newDiv.innerHTML=this.nextSibling.innerHTML;
				newDiv.innerHTML=$("#AllSort dt").siblings().eq(0).html();
