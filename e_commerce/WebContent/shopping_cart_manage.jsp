...
<div class="container">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="shopping_cart_manage.jsp">购物车管理</a></li>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="row" items="${result.rows}">
                <tr>
                    ...
                    <td><a class="btn btn-default" href="shopping_cart_modify.jsp?uid=${row.uid}&gid=${row.gid}&vid=${row.vid}" role="button">修改</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
