...
<div class="container">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="shopping_record_manage.jsp">销售记录管理</a></li>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="row" items="${result.rows}">
                <tr>
                    ...
                    <td><a class="btn btn-default" href="shopping_record_modify.jsp?oid=${row.oid}&gid=${row.gid}&vid=${row.vid}" role="button">修改</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
